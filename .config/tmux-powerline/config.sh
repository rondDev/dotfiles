...
# General {
	...
	export TMUX_POWERLINE_STATUS_LEFT_LENGTH="6000"
	# The maximum length of the right status bar.
	export TMUX_POWERLINE_STATUS_RIGHT_LENGTH="900"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/rond/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/rond"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/rond/.mailcheckrc"
# }
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_UPDATE_PERIOD="6"
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="59.406547"
	TMUX_POWERLINE_SEG_WEATHER_LON="5.305456"
# }
