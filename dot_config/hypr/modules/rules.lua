...
-- gaming
hl.window_rule({ match = { class = "^(osu!|cs2|Terraria.bin.x86_64)$" }, immediate = true })
...
hl.workspace_rule({ workspace = "special:magic", default_name = "spotify", on_created_empty = "spotify" })
